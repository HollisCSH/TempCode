...
uint8_t MX_TIM2_Init(void)
{
	...
	htim2.Instance = TIM2;
	htim2.Init.Prescaler = PRESCALER_VALUE;			//PRESCALER_VALUE	15999
	htim2.Init.CounterMode = TIM_COUNTERMODE_UP;	
	htim2.Init.Period = PERIOD_VALUE ;				//PERIOD_VALUE		1000-1
...
uint8_t MX_TIM3_Init(void)	//作为四等延迟函数
{
	...
	htim3.Instance = TIM3;
	htim3.Init.Prescaler = PRESCALER_VALUE;		//分频至1M
...
uint8_t MX_LPTIM1_Init(void)
{
	...
	hlptim1.Init.Clock.Prescaler = LPTIM_PRESCALER_DIV1;          	//设置LPTIM时钟分频
