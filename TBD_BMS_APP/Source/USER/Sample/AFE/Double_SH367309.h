...
//描述	    :
//=============================================================================================
#ifndef _DOUBLE_SH367309_H_
#define _DOUBLE_SH367309_H_
...
#define		SH367309_H_WRITE_EEP_ON		BSPGPIOSetPin(SH367309_H_VPRO_PORT,SH367309_H_VPRO_PIN);
#define		SH367309_H_WRITE_EEP_OFF    BSPGPIOClrPin(SH367309_H_VPRO_PORT,SH367309_H_VPRO_PIN);
#endif
...
#if defined(USE_B22_IM_PCBA)
#define		SH367309_H_SHIP_ON		    BSPGPIOClrPin(SH367309_H_SHIP_PORT,SH367309_H_SHIP_PIN);
#define		SH367309_H_SHIP_OFF         BSPGPIOSetPin(SH367309_H_SHIP_PORT,SH367309_H_SHIP_PIN);
#endif

#define		SH367309_IIC_ENABLE		    BSPGPIOSetPin(IIC_ENABLE_PORT,IIC_ENABLE_PIN);
#define		SH367309_IIC_DISABLE        BSPGPIOClrPin(IIC_ENABLE_PORT,IIC_ENABLE_PIN);

//----------------------------SH367309 IIC通信相关---------------------------------------------------
#define		SH367309_IIC_CHANNEL		eIIC0	//使用IIC0通道
#define		SH367309_IIC_CHANNEL_H		eIIC1	//使用IIC1通道
...
#define 	SH367309_VOLT_NUM    		17		//IC读取单体电压信息最大节数
#elif defined(LFP_TB_20000MAH_20S)
#define 	SH367309_VOLT_NUM    		20		//IC读取单体电压信息最大节数
#endif

#if defined(SY_PB_32000MAH_17S)
#define 	SH367309_VOLT_H_NUM    		7		//高端IC读取单体电压信息最大节数
#define 	SH367309_VOLT_L_NUM         10		//低端IC读取单体电压信息最大节数
#elif defined(LFP_TB_20000MAH_20S)
#define 	SH367309_VOLT_H_NUM    		10		//高端IC读取单体电压信息最大节数
#define 	SH367309_VOLT_L_NUM         10		//低端IC读取单体电压信息最大节数
#endif

#define 	SH367309_TEMP_H_NUM    		3		//高端IC读取单体温度信息最大节数
#define 	SH367309_TEMP_L_NUM         3		//低端IC读取单体温度信息最大节数

#define 	SH367309_TEMP_NUM    		6		//IC读取温度信息最大节数
...
#define		SH367309_VALID_BAT			0X1FFFF
...
#define 	SH367309_SAMPLE_RES_CAL_MIN 		300//900
...
#elif defined(LFP_TB_20000MAH_20S)
#define 	SH367309_CFG_OCC	            2500	//充电过流保护配置 25A
#else
...
typedef enum
{
    ...
    e_SH_AFE_Sta_Bqinit_H = 3,    
    e_SH_AFE_Sta_Norm = 4,
    e_SH_AFE_Sta_Offline = 5,
}e_SH_AFESTA;
...
typedef struct __SH_AFE_DATA
{
    ...
    u8  initerr_h;    	  	            //SH367309初始化异常标志
    u16 iicerr;			                //SH367309通信错误计数器
    u16 iicerr_h;			            //SH367309高端通信错误计数器
...
typedef struct __SH_AFE_CTRL
{
    ...
    u32 balctrl;			  			//SH367309 均衡控制，每1bit为1代表开均衡
...
extern t_SH367309_Register gSHAFEReg_H;                        //SH367309高端寄存器结构体
