...
#define		SH367309_WRITE_EEP_ON		HAL_GPIO_WritePin(VPRO_AFE_PORT, VPRO_AFE_PIN, GPIO_PIN_SET);//默认拉低，给AFE写EEPROM参数时必须拉高
#define		SH367309_WRITE_EEP_OFF      HAL_GPIO_WritePin(VPRO_AFE_PORT, VPRO_AFE_PIN, GPIO_PIN_RESET);

#define		SH367309_SHIP_ON		    HAL_GPIO_WritePin(SH367309_ON_PORT, SH367309_ON_PIN, GPIO_PIN_RESET);//默认拉高，拉低之后AFE进入仓运模式（休眠2uA）
#define		SH367309_SHIP_OFF           HAL_GPIO_WritePin(SH367309_ON_PORT, SH367309_ON_PIN, GPIO_PIN_SET);
//----------------------------SH367309 IIC通信相关---------------------------------------------------
#define		SH367309_IIC_CHANNEL		I2C1	//RTC使用IIC0通道
